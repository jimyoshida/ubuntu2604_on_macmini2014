...
| [playbooks/cloud-cli/](playbooks/cloud-cli/README.md) | Cloud/service CLI tools (auth0-deploy-cli, aws, az, az devops, gcloud, gcx, gh, glab, influx, jenkins, jira, logcli, tofu, promtool/amtool, vault, Azure PowerShell) |
